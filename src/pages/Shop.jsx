...
export default function Shop() {
  ...
  return (
    <div className="mt-40 max-w-screen-2xl mx-auto text-center md:px-28 px-4 py-6">
      <div
        className={`flex items-center gap-2 md:pt-8 ${
          state ? "pt-40" : "pt-8"
        } text-Black/50`}
      >
        <a href="/">Home</a>
      ...
      <h2 className="text-Black text-2xl font-primary font-semibold p-1 m-1">
        All Products
      </h2>
      {/* btns */}
      <div className="flex flex-col md:flex-row justify-between py-6 lg:px-28 px-4">
        <div className="flex flex-col md:flex-row flex-wrap justify-start md:gap-8 gap-2 ">
          <button className="border-none" onClick={() => handleFilter("all")}>
            All Products
          </button>
          <button
          ...
          <button className="border-none" onClick={() => handleFilter("AC")}>
            AC
          </button>
          <button className="border-none" onClick={() => handleFilter("Bed")}>
            Bed
          </button>
          <button
            className="border-none"
            onClick={() => handleFilter("Washing Machine")}
          >
            Washing Machine
          </button>
        </div>

...
export default function SingleProduct() {
  ...
  const [falseQuantity, setFalseQuantity] = useState(true);
  useEffect(() => {
    if (selectedProductQuantity < 1 || selectedProductQuantity > 4) {
      setFalseQuantity(true);
    } else {
      setFalseQuantity(false);
    }
  ...
  useEffect(() => {
    const selectedProduct = DUMMY_PRODUCTS.filter(
                      ...
                      <div className="text-left flex flex-col gap-2 w-full">
                        ...
                        {falseQuantity && (
                          <p className="text-red-500">
                            Please enter a valid quantity to confirm order. Must
                            be greater than 0 and less than 5
                          </p>
                        )}
                        <input

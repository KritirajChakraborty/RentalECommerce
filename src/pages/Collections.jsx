            ...
            <div className='h-[500px] flex flex-col md:flex-row'>
                <div className='md:w-1/2'></div>
                 <div className='md:w-1/2 pt-32'>
                   ...
                   <Link to='/shop'>
                   <button onClick={handleClick} className='bg-white text-Black border-none font-semibold px-6 py-2 capitalize rounded-sm hover:bg-orange-500 transition-all duration-200'>See Collections</button>
                   </Link>
                </div>
            </div>
        </div>

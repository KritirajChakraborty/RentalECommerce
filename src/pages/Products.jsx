...
export default function Products() {
  ...
  return (
    <div className="max-w-screen-2xl mx-auto md:px-28 px-4 mb-16">
      <h3 className="font-primary text-3xl font-semibold text-center capitalize p-1 m-1">
      ...
      <div className="flex flex-col md:flex-row justify-between py-6 lg:px-28 px-4">
        <div className="flex flex-col md:flex-row flex-wrap justify-start md:gap-8 gap-2 border-none ">
          <button
            className="border-none hover:text-orange-500"
        ...
        {/* sorting options */}
        <div className="pt-10 flex flex-col md:flex-row flex-wrap justify-end gap-6">
          <select
            name="sort"
            id="sort"
            multiple={true}
